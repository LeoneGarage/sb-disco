...
# MAGIC %fs
# MAGIC
# MAGIC cp s3://datalake-shared-resources-etl-artifact-prd-twycaj6ki1az/app/bronze/demo_app/017390273/pipeline-package.zip dbfs:/Users/leon.eller@databricks.com/zips/pipeline-package.zip

# COMMAND ----------

# MAGIC %fs
# MAGIC
# MAGIC cp dbfs:/Users/leon.eller@databricks.com/zips/pipeline-package.zip s3://datalake-shared-resources-etl-artifact-prd-twycaj6ki1az/app/bronze/demo_app/017390273/pipeline-package.zip

# COMMAND ----------

# MAGIC %sh
# MAGIC
# MAGIC cp /dbfs/Users/leon.eller@databricks.com/zips/pipeline-package.zip /Workspace/Shared/pipeline-package.zip

# COMMAND ----------

# MAGIC %sh
# MAGIC
# MAGIC curl https://github.com/LeoneGarage/sb-disco/raw/main/db_submit.zip -L -o /dbfs/Users/leon.eller@databricks.com/zips/db_submit.zip

# COMMAND ----------

# MAGIC %sh
# MAGIC
# MAGIC curl https://github.com/LeoneGarage/sb-disco/raw/main/lakehouselib-latest.zip -L -o /dbfs/Users/leon.eller@databricks.com/zips/lakehouselib-latest.zip

# COMMAND ----------

# MAGIC %fs
# MAGIC
# MAGIC cp s3://datalake-shared-resources-etl-artifact-prd-twycaj6ki1az/app/bronze/demo_app/017390273/libs/lakehouselib-latest.zip s3://datalake-shared-resources-etl-artifact-prd-twycaj6ki1az/packages/sportsbet/lakehouselib/pip/lakehouselib-latest.zip

# COMMAND ----------

# MAGIC %fs
# MAGIC
# MAGIC ls s3://datalake-shared-resources-etl-artifact-prd-twycaj6ki1az/packages/sportsbet/lakehouselib/pip/

# COMMAND ----------

# MAGIC %fs
# MAGIC
# MAGIC ls s3a://datalake-python-repo-ap-southeast-2-dv2t4qi6u0ds/packages/sportsbet/lakehouselib/pip/lakehouselib-latest.zip
...
# MAGIC [DEFAULT]
# MAGIC host = https://sportsbet-data-platforms-prd.cloud.databricks.com
...
# MAGIC CLUSTER_SPEC='{
# MAGIC         "cluster_name":"",
# MAGIC         "spark_version":"13.2.x-scala2.12",
# MAGIC         "spark_conf": {
...
# MAGIC         },
# MAGIC         "instance_pool_id":"0710-115244-eases83-pool-85r6lc2b",
# MAGIC         "driver_instance_pool_id":"0710-115450-strip84-pool-hqm6madv",
